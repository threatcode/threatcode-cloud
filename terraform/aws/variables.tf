...
variable "public_key_name" {
  description = "A name for AWS Keypair to use to auth to authenticate to Threat Code."
  default     = "threatcode"
}

variable "public_key_path" {
  description = "Path to the public key to be loaded into the Threat Code authorized_keys file"
  type        = string
  default     = "~/.ssh/threatcode.pub"
}

variable "private_key_path" {
  description = "Path to the private key to use to authenticate to Threat Code."
  type        = string
  default     = "~/.ssh/threatcode"
}
